            ...
            <tbody class="bg-white">
              <tr v-for="book in books" :key="book.book_id">
                ...
                <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                  <span>{{ book.book_update }}</span>
                </td>
                <MyModal :title="modalTitle" ref="myModal">
                  <template v-slot:modal-body="{ book }">
                    <p>{{ book.book_name }}</p>
                    <p>{{ book.book_desc }}</p>
                  </template>
                </MyModal>
                ...
                <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                  <a @click="openModal(book)" href="#" class="text-indigo-600 hover:text-indigo-900" data-modal-target="updateModal"
