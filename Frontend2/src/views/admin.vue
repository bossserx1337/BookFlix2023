...
<div class="container max-w-7xl mx-auto mt-8">
  ...
  <div class="flex flex-col">
    <div class="overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        ...
        <table class="min-w-full">
          ...
          <tbody class="bg-white">
            <tr v-for="book in books" :key="book.book_id">
              ...
              <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                <a :href="'/book/' + book.book_id+ '/chapter'" target="_blank" class="text-gray-600 hover:text-gray-900">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div class="mt-8 ml-4">
        <button class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded" type="submit" @click="update(newbook)">update</button>
